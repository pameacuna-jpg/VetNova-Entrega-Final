...
public class NotificacionServiceTest {
    ...
    void crear_conCanalSms_deberiaUsarTelefonoComoDestinatario() {
        ...
        when(clienteClient.obtenerClientePorId(1L)).thenReturn(cliente);
        when(notificacionRepository.save(any(Notificacion.class))).thenReturn(notificacionSms);
    ...
    void crear_conCanalWhatsapp_deberiaUsarTelefonoComoDestinatario() {
        ...
        when(clienteClient.obtenerClientePorId(1L)).thenReturn(cliente);
        when(notificacionRepository.save(any(Notificacion.class))).thenReturn(notificacionWhatsapp);
    ...
    void crear_cuandoClienteEsNull_deberiaLanzarNegocioException() {
        ...
        assertEquals("No fue posible obtener los datos del cliente", exception.getMessage());
    ...
    void crear_cuandoClienteInactivo_deberiaLanzarNegocioException() {
        ...
        assertEquals("El cliente no se encuentra activo", exception.getMessage());
        verify(notificacionRepository, never()).save(any(Notificacion.class));
    }
    ...
    void crear_emailSinCorreo_deberiaLanzarNegocioException() {
        ...
        assertEquals("El cliente no tiene email registrado", exception.getMessage());
        verify(notificacionRepository, never()).save(any(Notificacion.class));
    }
    ...
    void crear_smsSinTelefono_deberiaLanzarNegocioException() {
        ...
        assertEquals("El cliente no tiene teléfono registrado", exception.getMessage());
        verify(notificacionRepository, never()).save(any(Notificacion.class));
    }
    ...
    void listar_deberiaRetornarTodasLasNotificaciones() {
        ...
        assertEquals(1L, resultado.get(0).getIdNotificacion());
    ...
    void buscarPorId_cuandoNoExiste_deberiaLanzarRecursoNoEncontradoException() {
        ...
        assertEquals("No existe una notificación con id 99", exception.getMessage());
    ...
    void buscarPorCliente_deberiaRetornarNotificacionesDelCliente() {
        when(clienteClient.obtenerClientePorId(1L)).thenReturn(cliente);
        when(notificacionRepository.findByIdCliente(1L)).thenReturn(Arrays.asList(notificacion));

        List<NotificacionResponseDTO> resultado = notificacionService.buscarPorCliente(1L);
    ...
    void buscarPorEstado_deberiaRetornarNotificacionesPorEstado() {
        ...
        List<NotificacionResponseDTO> resultado =
                notificacionService.buscarPorEstado(EstadoNotificacion.PENDIENTE);
    ...
    void buscarPorTipo_deberiaRetornarNotificacionesPorTipo() {
        when(notificacionRepository.findByTipo(TipoNotificacion.STOCK_BAJO))
                .thenReturn(Arrays.asList(notificacion));

        List<NotificacionResponseDTO> resultado =
                notificacionService.buscarPorTipo(TipoNotificacion.STOCK_BAJO);

        assertEquals(1, resultado.size());
        assertEquals(TipoNotificacion.STOCK_BAJO, resultado.get(0).getTipo());

        verify(notificacionRepository).findByTipo(TipoNotificacion.STOCK_BAJO);
    }
    ...
    void marcarComoEnviada_cuandoPendiente_deberiaActualizarEstado() {
        ...
        when(notificacionRepository.save(any(Notificacion.class))).thenReturn(notificacionEnviada);
    ...
    void marcarComoEnviada_cuandoYaEstaEnviada_deberiaLanzarNegocioException() {
        ...
        assertEquals("La notificación ya se encuentra marcada como ENVIADA", exception.getMessage());
        verify(notificacionRepository, never()).save(any(Notificacion.class));
    }
    ...
    void marcarComoError_cuandoPendiente_deberiaActualizarEstado() {
        ...
        when(notificacionRepository.save(any(Notificacion.class))).thenReturn(notificacionError);

        NotificacionResponseDTO resultado = notificacionService.marcarComoError(1L);

        assertEquals(EstadoNotificacion.ERROR, resultado.getEstado());
    ...
    void marcarComoError_cuandoYaEstaError_deberiaLanzarNegocioException() {
        ...
        assertEquals("La notificación ya se encuentra marcada como ERROR", exception.getMessage());
        verify(notificacionRepository, never()).save(any(Notificacion.class));
    }
